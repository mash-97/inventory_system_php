      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form method="post" action="categorie.php">
            ...
            <button type="submit" name="add_cat" class="btn btn-danger">Add Category</button>
        </form>
        </div>
      </div>
    </div>
                ...
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        ...
                        <a href="delete_categorie.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-sm btn-danger" data-toggle="tooltip" title="Remove">
