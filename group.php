  ...
  <div class="col-md-12">
    ...
    <div class="panel-heading clearfix">
      <strong>
       ...
       <a href="add_group.php" class="btn btn-danger pull-right btn-sm"> Add New Group</a>
    </div>
          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                ...
                <a href="delete_group.php?id=<?php echo (int)$a_group['id'];?>" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Remove">
